			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label for="" class="control-label">Học sinh</label>
					...
					<div class="form-group">
						<label for="" class="control-label">Hình thức</label>
				...
				<div class="col-md-6">
					<div class="form-group for-repeating">
						<label for="dow" class="control-label">Ngày trong tuần</label>
					...
					<div class="form-group for-nonrepeating" style="display: none">
						<label for="" class="control-label">Ngày học</label>
