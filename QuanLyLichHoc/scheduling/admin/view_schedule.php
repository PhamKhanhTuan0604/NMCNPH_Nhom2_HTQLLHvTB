...
<div class="container-fluid">
	<p>Lịch học: <b><?php echo ucwords($title) ?></b></p>
	<p>Miêu tả: <b><?php echo $description ?></b></p>
	<p>Địa điểm: </i> <b><?php echo $location ?></b></p>
	<p>Thời gian bắt đầu: </i> <b><?php echo date('h:i A',strtotime("2020-01-01 ".$time_from)) ?></b></p>
	<p>Thời gian kết thúc: </i> <b><?php echo date('h:i A',strtotime("2020-01-01 ".$time_to)) ?></b></p>
	<hr class="divider">
</div>
