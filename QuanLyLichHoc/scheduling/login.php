  		...
  		<div id="login" class="col-md-4">
  			<div class="card">
  				<div class="card-body">
  					...
  					<form id="login-form" >
					  <h4><b>Chào mừng đến với hệ thống lịch học cá nhân</b></h4>
  						<div class="form-group">
  							<label for="id_no" class="control-label">Vui lòng nhập mã ID học sinh của bạn</label>
